...
interface RecentVideo { id: string; s3Url: string; metadata: { model?: string; prompt?: string; brandId?: string } | null; createdAt: string }

export default function VideoThumb({ video }: { video: RecentVideo }) {
